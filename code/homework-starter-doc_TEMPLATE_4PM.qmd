...
**Root mass and total mass are strongly positively correlated (Pearson's r = 0.58)**
...
```
**plants with higher biomass have bigger ranges (grindelia, gumweed, purple needle grass), plants with lower biomass have smaller ranges (deerweed, scarlet buggler, purple sage)**
...
ggplot(data = drought_exp_clean, # data frame
  ...
  geom_jitter(width = 0.1, # narrow jitter
              height = 0) # not jittering points up and down
```
**well watered plants have larger biomass; total biomass greater when plants are well watered**
...
```
**There might be a slight positive correlation. Moderate (or strong depending on how you round) correlation/relationship** 
...
**total mass as a function of none of the predictors**
...
1. ** 
**total mass predicted by SLA, water treatment, and species**  
...
**whatever doesnt show up in the model**
...
- SLA slope: **for each 1 unit increase in SLA (mm^2/g), you expect a decrease in plant mass of 0.002 +- (0.0005. SO NO EFFECR OF SLA ON MASS** **across drought treatments and species, with each 1 unit increase in SLA (mm^2^/dry mass of leaf), we expect an increase in total mass of -0.00025 WHICH MEANS WITH THE ESTIMATE AND STANDARD ERROR THERE IS NO EFFECT OF SLA ON TOTAL MASS**  
- well watered estimate: **across species and SLA, well watered plants tend to be 0.12 g heavier (or more massive) than drought stressed plants** 

**across species and SLA, well watered plants tend to be 0.12 +- (figure out how to write plus minus in text) 0.02 g heavier than drought stressed plants**    
- Lotus scoparius estimate: **insert response here**    
- Stipa pulchra estimate: **insert response here**    

# Model predictions

**water treatment significantly predicts mass**
