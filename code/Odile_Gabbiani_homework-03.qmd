...
b. Table 2. Dataset for ammonium-nitrogen, total nitrogen and total phosphorus removal rates, lists each plant studied, its vegetation cover, and the amount of ammonium-nitrogen, total nitrogen, and total phosphorous it was able to remove from an aquatic system. To visualize the data displayed in Table 2, I would suggest the authors use a bar graph that has the plants on the the x axis, along with the percentage of total nitrogen and total phosphorous removed. The y axis would quanify the amount the plant was able to remove as a percentage. Each plant would have two bars, one for TN and the other for TP. To differentiate between total nitrogen and total phosphorous, different colors could be used for those two bars.   
